											...
											case "ЕГБДП":
												switch($elem['request']){
													case $request_state[0]: 
														...
														if ($table_name != $table_name_befo){
															echo '<tr><td align="center" colspan="10">Предоставить доступ:</td></tr>';
															echo '<tr><td>Фамилия, имя, отчество</td><td>Код органа (УНП)</td><td>Должноть</td><td colspan="7">Код ИМНС</td></tr>';
														}
														$view_table .='<td>'.$elem['fio'].'</td>';
														$view_table .='<td>'.$elem['unp'].'</td>';
														$view_table .='<td>'.$elem['job'].'</td>';
														$view_table .='<td colspan="7">'.$elem['number'].'</td>';
														$view_table .= '</tr>';
														echo $view_table;
														break;
													case $request_state[1]: 
														...
														if ($table_name != $table_name_befo){
															echo '<tr><td align="center" colspan="10">Прекратить доступ:</td></tr>';
															echo '<tr><td>Фамилия, имя, отчество</td><td>Имя пользователя</td><td>Код органа (УНП)</td><td colspan="7">Код ИМНС</td></tr>';
														}
														$view_table .='<td>'.$elem['fio'].'</td>';
														$view_table .='<td>'.$elem['login'].'</td>';
														$view_table .='<td>'.$elem['unp'].'</td>';
													...
													case $request_state[2]: 
														...
														if ($table_name != $table_name_befo){
															echo '<tr><td align="center" colspan="10">Продлить доступ:</td></tr>';
															echo '<tr><td>Фамилия, имя, отчество</td><td>Имя пользователя</td><td>Код органа (УНП)</td><td>Примечание</td><td colspan="6">Код ИМНС</td></tr>';
														}	
														$view_table .='<td>'.$elem['fio'].'</td>';
														$view_table .='<td>'.$elem['login'].'</td>';
														$view_table .='<td>'.$elem['unp'].'</td>';
														$view_table .='<td>Доступ продлить</td>';
														$view_table .='<td colspan="6">'.$elem['number'].'</td>';
														$view_table .= '</tr>';
														echo $view_table;
														break;
													case $request_state[3]: 
													...
													case $request_state[4]: 
														...
														if ($table_name != $table_name_befo){ 
															...
															echo '<tr><td>Примечание. 1 Сброс пароля 2 Изменение сведений</td><td>Фамилия, имя, отчество</td><td>Имя пользователя</td><td>Код органа (УНП)</td><td>Новые данные</td><td>Примечание</td><td colspan="4">Код ИМНС</td></tr>';
														}	
														$view_table .='<td> </td>';
														$view_table .='<td>'.$elem['fio'].'</td>';
														$view_table .='<td>'.$elem['login'].'</td>';
														...
														$view_table .='<td></td>';
														$view_table .='<td colspan="4">'.$elem['number'].'</td>';
														$view_table .= '</tr>';
														echo $view_table;
														break;	
